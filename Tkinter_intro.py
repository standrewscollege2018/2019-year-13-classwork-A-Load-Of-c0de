...
welcome_label = Label(root, text="Welcome to my first GUI", bg='#123456', fg='#ffffff', font=('Chalkboard', 30))
...
user_label = Label(root, text="Username", bg='#123456', fg='#ffffff',font=('Chalkboard', 20)).grid(row=1, column=0, sticky=W)
user_entry = Entry(root).grid(row=1, column=1,sticky=W)

# to align grid content, we use sticky, with N, E, S, W for top, right, bottom, left
password_label = Label(root, text="Password", bg='#123456', fg='#ffffff',font=('Chalkboard', 20)).grid(row=2, column=0, sticky=W)
password_entry = Entry(root).grid(row=2, column=1, sticky=W)
